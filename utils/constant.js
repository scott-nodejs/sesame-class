...
export const TASK_NAME_NOTEMPTY = '任务名称不能为空'
export const TASK_USER_NOTEMPTY = '人数不能为空'
export const TASK_NUM_NOTEMPTY = '数量不能为0'
export const TASK_TIME_NOTEMPTY = '时间不能为空'
export const TASK_TIME_ERROR = '结束时间不能小于或等于开始时间'
