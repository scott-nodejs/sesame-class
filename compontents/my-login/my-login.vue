<template>
  <view class="my-container">
    <!-- 用户未登录 -->
    <block v-if="!token">
      <image class="avatar avatar-img" src="https://img.hazer.top/classImage/assets/default_avatar.png" mode="scaleToFill" />
    ...
    <block v-else>
	  ...
	  <button class="login-btn" type="default" @click="updateAvatorUrl">更新头像和昵称</button>
	  <button open-type="feedback" class="login-btn" type="default" >建议反馈</button>
